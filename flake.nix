{
  ...
  inputs.nix-darwin.url = "github:nix-darwin/nix-darwin/a41d518ea85b68d6555d0b6827f82896ad17f837"; # TODO: switch to branch
  ...
  inputs.nixpkgs-kitty.url = "github:NixOS/nixpkgs/56e52bc01e46bed49434b22d910d5becdb716fac";
