...
let
  ...
  vars = import ../nixos/var/variables.nix { inherit pkgs; };
  ...
  #imports = [
    ...
    home = {
      ...
      sessionVariables = {
        ...
        GOPATH="${vars.homeDir}";
        GOBIN="${goBinDir}";
        PATH="${binDir}:${goBinDir}:${rubyBinDir}:${npmBinDir}:\${PATH}";
    ...
    programs = {
      zsh = {
        ...
        initExtra = ''
          ...
          HISTFILE="${xdgConfigHome}/zsh/.zhistory"
          bindkey -v
          ...
          source ${xdgDataHome}/base16/scripts/base16-tomorrow-night.sh
        ...
        shellAliases= {
          ...
          gr="git remote";
          gB="git rebase";
          gBc="git rebase --continue";
          gBac="git add . && git rebase --continue";
          gm="git cherry-pick";
          gM="git merge";
          gp="git pull";
          gpp="git pull --prune";
